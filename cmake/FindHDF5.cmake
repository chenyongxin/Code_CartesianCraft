...
# The default script from CMake, which is customized by CHEN Yongxin.
# This module will set the following additional variables in your project:
# ``HDF5_INCLUDE_DIR``
...
if(NOT "$ENV{LIBRARY_PATH}" STREQUAL "")
  string(REPLACE ":" ";" HDF5_LIBRARY_PATH $ENV{LIBRARY_PATH})
endif()
if(NOT "$ENV{CPATH}" STREQUAL "")
  string(REPLACE ":" ";" HDF5_INCLUDE_PATH $ENV{CPATH})
endif()
